...
@SlingServlet(
        ...
        selectors = { GetFileExtension.SEL_FOLDER_SIZE },
        methods = "GET")
public class GetFileExtension extends SlingAllMethodsServlet {
    private static final Logger log = LoggerFactory.getLogger(GetFileExtension.class);
